...
class Migration(migrations.Migration):
    """Initial scrapers schema migration."""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('http_etag', models.CharField(blank=True, help_text='Last ETag seen for the product HTML, for conditional GETs', max_length=250)),
                ('http_last_modified', models.CharField(blank=True, help_text='Last Last-Modified seen for the product HTML', max_length=100)),
