    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_at', models.DateTimeField(blank=True, help_text='When this extraction was approved into the catalog', null=True)),
                ('approved_product', models.ForeignKey(blank=True, help_text='Catalog product created from this extraction', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_scraper_extractions', to='core.product')),
