...
<template>
  ...
  >
    <div
      class="app-pagination__summary flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-center md:justify-start md:text-left"
    >
    ...
    <div
      class="app-pagination__nav flex flex-wrap items-center justify-center gap-2 rounded-2xl p-2 md:justify-end"
    >
      <button
        type="button"
        aria-label="Go to previous page"
        class="app-button app-button--ghost app-button--control inline-flex items-center gap-2 px-3 disabled:cursor-not-allowed disabled:opacity-40 sm:px-4"
      ...
      <template
        v-for="item in buildPages(pageInfo)"
      ...
      >
        <button
          ...
          :class="item.value === pageInfo.currentPage ? 'app-button--accent' : 'app-button--ghost'"
