    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_manually_curated', models.BooleanField(default=False, help_text='If checked, the scraper will NOT update the name, description, or brand of this product.', verbose_name='Manually Curated')),
